      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <ScrollReveal key={testimonial.name} variant="fade-up" delayMs={index * 90}>
              <article className="flex h-full flex-col rounded-2xl border border-neutral-200 bg-neutral-50 p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div
